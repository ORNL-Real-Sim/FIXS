...
class SumoSimulation(object):
    ...
    def __init__(self,
        ...
        # Traffic light manager for the legacy landmark-based TLS sync path.
        self.traffic_light_manager = SumoTLManager() if use_landmark_tls else None

    @property
    def traffic_light_ids(self):
        if self.traffic_light_manager is None:
            return set()
