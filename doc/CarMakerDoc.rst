...
* `Simulation Setups`_
    * `Setup CM Office or Simulink`_
        * `Obtain CarMaker Executables`_
        * `Compile Source Codes`_
    * `Setup CM dSPACE`_
        * `Obtain dSPACE library`_
        * `Compile dSPACE library`_
        * `Prepare User.c`_
        * `Prepare for dSPACE build (configuration desk)`_
            * `Additional instructions for RS Simulink libraries`_
...
- source files (in \\CommonLib folder)
    ...
    .. image:: img/CM_VS_Sources.png

- dependencies folders
    
    .. image:: img/CM_VS_IncludeDependencies.png

- libraries
    
    .. image:: img/CM_VS_Inputs.png
...
RealSim comes with precompiled dSPACE library file that can be used directly under \\CommonLib. If plan to use these libraries directly, can skip the next section and go to `Prepare for dSPACE build (configuration desk)`_ section directly. Otherwise, follow the next section to compile customized dSPACE library.
...
.. image:: img/CM_DS_BuildConfig.png

- set number of accepted overruns to be -1 in ConfigurationDesk:

.. image:: img/DS_SCLX_NO_OVERRUN.png
...
.. image:: img/DS_SCLX_Eth_1.png

.. image:: img/DS_SCLX_Eth_2.png

.. image:: img/DS_SCLX_Eth_3.png

.. image:: img/DS_SCLX_Eth_4.png

.. image:: img/DS_SCLX_Eth_5.png
...
.. image:: img/CM_SUMO_SignalLight.png

.. image:: img/CM_SUMO_SignalController.png
...
.. image:: img/CM_Simulink_Config.png
...
2. Open the ConfigurationDesk project ``RS_DS_CM11_noSimulinkRS_useManeuver`` which is inside the ``CM11_proj/ConfigDesk`` folder. The simulink file is ``RS_DS_CM11_noSimulinkRS_useManeuver.slx`` under ``CM11_proj\src_cm4sl_ds``. Compile the ConfigurationDesk project. See more details in `Setup CM dSPACE`_ section
