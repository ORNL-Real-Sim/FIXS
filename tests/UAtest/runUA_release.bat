...
set CmProjPath=..\..\ProprietaryFiles\CM13_proj
...
python %RealSimPath%\CarMaker\RealSimSetCarMakerConfig.py --cm-project-path %CmProjPath% --configFile %configFilename% --signal-table-path %CmProjPath%\Data\Road\UA_Feb2024_TFlight_RSsignalTable.csv
