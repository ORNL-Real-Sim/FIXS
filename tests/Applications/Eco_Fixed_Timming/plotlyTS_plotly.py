...
OUTPUT_DIR = r".\Experiments_Sumo\Shallowford_after_calibration_banleftturn_AdjustedFixedTime_V3\MPR_3\Results"
...
def get_data(folder_path: str, verbose: bool = False) -> dict[str, dict[str,]]:
    ...
    folder = r"C:\Users\yusun\Projects\XIL_Oct\tests\Applications\Eco_Fixed_Timming\Experiments_Sumo\Shallowford_after_calibration_banleftturn_AdjustedFixedTime_V3\MPR_3\0%_10Hz_with_vehDyn_E_D_test0114"
...
data_dic_full = get_data(r".\Experiments_Sumo\Shallowford_after_calibration_banleftturn_AdjustedFixedTime_V3\MPR_3\0%_10Hz_with_vehDyn_E_D_test0114", verbose=True)
...
def plot_space_time_diagram_two_conditions(data_dic,
                                           condition_label = 'With_ego_28985_nopython',
                                           output_dir = r".\Experiments_Sumo\Shallowford_after_calibration_banleftturn_AdjustedFixedTime_V3\MPR_3\Results",
