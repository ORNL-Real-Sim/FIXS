/*
 * File: CVXGEN_Leader_Spd_ULMPC.c
 *
 *
 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Feb 28 20:24:23 2024
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME CVXGEN_Leader_Spd_ULMPC
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            16
/* Input Port  0 */
#define IN_PORT_0_NAME        vmax
...
/* Input Port  2 */
#define IN_PORT_2_NAME        deltav_max
...
/* Input Port  3 */
#define IN_PORT_3_NAME        deltav_min
...
/* Input Port  4 */
#define IN_PORT_4_NAME        vcmd_max
...
/* Input Port  5 */
#define IN_PORT_5_NAME        vcmd_min
...
/* Input Port  6 */
#define IN_PORT_6_NAME        delta_vcmd_max
...
/* Input Port  7 */
#define IN_PORT_7_NAME        delta_vcmd_min
...
/* Input Port  13 */
#define IN_PORT_13_NAME        v_ref
#define INPUT_13_WIDTH         21
...
/* Input Port  14 */
#define IN_PORT_14_NAME        v_cmd_last
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       delta_v_cmd_opt
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       v_cmd_opt
...
#define SOURCEFILES           "__SFB__solver.c__SFB__util.c__SFB__matrix_support.c__SFB__ldl.c"
#define PANELINDEX            8
...
extern void CVXGEN_Leader_Spd_ULMPC_Outputs_wrapper(const real_T *vmax,
			const real_T *vmin,
...
{
    const real_T *vmax = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *vmin = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *deltav_max = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *deltav_min = (real_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *vcmd_max = (real_T *) ssGetInputPortRealSignal(S, 4);
    const real_T *vcmd_min = (real_T *) ssGetInputPortRealSignal(S, 5);
    const real_T *delta_vcmd_max = (real_T *) ssGetInputPortRealSignal(S, 6);
    const real_T *delta_vcmd_min = (real_T *) ssGetInputPortRealSignal(S, 7);
    const real_T *A = (real_T *) ssGetInputPortRealSignal(S, 8);
    const real_T *B = (real_T *) ssGetInputPortRealSignal(S, 9);
    const real_T *d_k = (real_T *) ssGetInputPortRealSignal(S, 10);
    const real_T *Q = (real_T *) ssGetInputPortRealSignal(S, 11);
    const real_T *R = (real_T *) ssGetInputPortRealSignal(S, 12);
    const real_T *v_ref = (real_T *) ssGetInputPortRealSignal(S, 13);
    const real_T *v_cmd_last = (real_T *) ssGetInputPortRealSignal(S, 14);
    const real_T *x_0 = (real_T *) ssGetInputPortRealSignal(S, 15);
    real_T *delta_v_cmd_opt = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *v_cmd_opt = (real_T *) ssGetOutputPortRealSignal(S, 1);

    CVXGEN_Leader_Spd_ULMPC_Outputs_wrapper(vmax, vmin, deltav_max, deltav_min, vcmd_max, vcmd_min, delta_vcmd_max, delta_vcmd_min, A, B, d_k, Q, R, v_ref, v_cmd_last, x_0, delta_v_cmd_opt, v_cmd_opt);
