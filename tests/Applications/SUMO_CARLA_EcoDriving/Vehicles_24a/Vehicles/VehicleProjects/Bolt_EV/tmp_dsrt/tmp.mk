...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model tmp.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = tmp
MW_MODEL_MODULES                  = tmp_data.c tmp_dsrtmdlfcn.c tmp_dsrtmf.c tmp_dsrttf.c tmp_dsrtvdf.c
# MW_MODEL_MODULES_OBJ            = tmp_data.obj tmp_dsrtmdlfcn.obj tmp_dsrtmf.obj tmp_dsrttf.obj tmp_dsrtvdf.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = tmp_ref.rsp
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := tmp.$(MW_TARGET_LANG_EXT) 
