...
### File                  : EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom.mk
...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom.mk
MW_BUILDARGS                      =  MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
# MW_MATLAB_ROOT                  = "C:\Program Files\MATLAB\R2019b"
# MW_MATLAB_BIN                   = "C:\Program Files\MATLAB\R2019b\bin"
MATLAB_ROOT                       = C:\PROGRA~1\MATLAB\R2019b
MATLAB_BIN_ALT                    = C:\PROGRA~1\MATLAB\R2019b\bin
MW_RELEASE_VERSION                = R2019b
MW_RELEASE_VERSION               := $(MW_RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom
MW_MODEL_MODULES                  = EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_data.c EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsmpb_bd.c EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrtmdlfcn.c EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrtmf.c EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrttf.c EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
# MW_MODEL_MODULES_OBJ            = EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_data.obj EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsmpb_bd.obj EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrtmdlfcn.obj EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrtmf.obj EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrttf.obj EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = C:\GitDev\Anye\cave_carla_dev\Vehicles\VehicleProjects\Bolt_EV\Work
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom_dsrt" \
...
%set LIB_BASENAME = EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := EvBoltCalib_Lat_v1_comb_GBSRotoMachE_noCom.$(MW_TARGET_LANG_EXT) 
