 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Feb 27 15:50:30 2024
 */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  CVXGEN_Leader_Spd_ULMPC_Outputs_wrapper(vmax, vmin, deltav_max, deltav_min,
    vcmd_max, vcmd_min, delta_vcmd_max, delta_vcmd_min, A, B, d_k, Q, R, v_ref,
    v_cmd_last, x_0, delta_v_cmd_opt, v_cmd_opt);
}
