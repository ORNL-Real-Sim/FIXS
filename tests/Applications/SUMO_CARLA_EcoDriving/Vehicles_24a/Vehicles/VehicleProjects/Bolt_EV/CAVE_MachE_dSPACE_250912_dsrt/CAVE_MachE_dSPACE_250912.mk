...
### File                  : CAVE_MachE_dSPACE_250912.mk
...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model CAVE_MachE_dSPACE_250912.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = CAVE_MachE_dSPACE_250912.mk
MW_BUILDARGS                      =  MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=1"
# MW_MATLAB_ROOT                  = "C:\Program Files\MATLAB\R2024a"
# MW_MATLAB_BIN                   = "C:\Program Files\MATLAB\R2024a\bin"
MATLAB_ROOT                       = C:\PROGRA~1\MATLAB\R2024a
MATLAB_BIN_ALT                    = C:\PROGRA~1\MATLAB\R2024a\bin
MW_RELEASE_VERSION                = R2024a
MW_RELEASE_VERSION               := $(MW_RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = CAVE_MachE_dSPACE_250912
MW_MODEL_MODULES                  = CAVE_MachE_dSPACE_250912_data.c CAVE_MachE_dSPACE_250912_dsmpb_bd.c CAVE_MachE_dSPACE_250912_dsrtmdlfcn.c CAVE_MachE_dSPACE_250912_dsrtmf.c CAVE_MachE_dSPACE_250912_dsrttf.c CAVE_MachE_dSPACE_250912_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
# MW_MODEL_MODULES_OBJ            = CAVE_MachE_dSPACE_250912_data.obj CAVE_MachE_dSPACE_250912_dsmpb_bd.obj CAVE_MachE_dSPACE_250912_dsrtmdlfcn.obj CAVE_MachE_dSPACE_250912_dsrtmf.obj CAVE_MachE_dSPACE_250912_dsrttf.obj CAVE_MachE_dSPACE_250912_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = C:\GitSrc\XIL_EcoPilot\FIXS\tests\Applications\Eco_Fixed_Timming\Vehicles_24a\Vehicles\VehicleProjects\Bolt_EV
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = CAVE_MachE_dSPACE_250912_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\CAVE_MachE_dSPACE_250912_dsrt" \
    "$(START_DIR)\System" \
...
%set DSRT_COMMON_SRC_DIRPATHS += \
    ...
    "$(MATLAB_ROOT)\toolbox\simulink\blocks\src"
...
%set LIB_BASENAME = CAVE_MachE_dSPACE_250912
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := CAVE_MachE_dSPACE_250912.$(MW_TARGET_LANG_EXT) 
