...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model CAVE_MachE_sil_test.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = CAVE_MachE_sil_test.mk
...
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = CAVE_MachE_sil_test
MW_MODEL_MODULES                  = CAVE_MachE_sil_test_data.c CAVE_MachE_sil_test_dsrtmdlfcn.c CAVE_MachE_sil_test_dsrtmf.c CAVE_MachE_sil_test_dsrttf.c CAVE_MachE_sil_test_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
# MW_MODEL_MODULES_OBJ            = CAVE_MachE_sil_test_data.obj CAVE_MachE_sil_test_dsrtmdlfcn.obj CAVE_MachE_sil_test_dsrtmf.obj CAVE_MachE_sil_test_dsrttf.obj CAVE_MachE_sil_test_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = 
# MW_SOLVER                       = 
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = C:\GitDev\Anye\cave_carla_dev\Vehicles\VehicleProjects\Bolt_EV
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = CAVE_MachE_sil_test_ref.rsp
...
%set DSRT_COMMON_HDR_DIRPATHS += \
    "$(START_DIR)" \
    "$(START_DIR)\CAVE_MachE_sil_test_dsrt" \
...
%set LIB_BASENAME = CAVE_MachE_sil_test
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := CAVE_MachE_sil_test.$(MW_TARGET_LANG_EXT) 
