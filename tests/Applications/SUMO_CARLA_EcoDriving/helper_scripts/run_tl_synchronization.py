...
class tlSynchronization(object):
    def __init__(self,
        ...
        self.carla.world = self.carla.client.load_world('Town01')
        print(f"Map 'Town01' loaded successfully. Current map name: {self.carla.world.get_map().name}")
...
def synchronization_loop(args):
    ...
    synchronization = tlSynchronization(sumo_simulation, carla_simulation, 'sumo')
