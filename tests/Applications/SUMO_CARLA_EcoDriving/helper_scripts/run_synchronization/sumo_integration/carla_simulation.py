...
import carla
from matplotlib.pyplot import table  # pylint: disable=import-error
...
class CarlaSimulation(object):
    ...
    """
    def __init__(self, host, port, step_length, tl_table_path):
        ...
        # self._tls_rows, self._tls_table = self.load_tl_table(tl_table_path)
    ...
    def traffic_light_ids(self):
        return set(self._tls_table.keys())
