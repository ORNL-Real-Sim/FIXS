...
Time = out.DesiredSpeed.time;                  
DesiredSpeed = out.DesiredSpeed.signals.values;
ActualSpeed = out.ActualSpeed;

ActualSpeed = ActualSpeed(:);           
MPG = out.MPG.signals.values;
FuelComsumption = out.FuelComsumption.signals.values;
EngineSpeed = out.EngineSpeed.signals.values;
EngineTorque = out.EngineTorque.signals.values;
T = table(Time, DesiredSpeed, ActualSpeed, MPG, FuelComsumption, EngineSpeed, EngineTorque,'VariableNames', {'Time', 'DesiredSpeed', 'ActualSpeed', 'MPG', 'FuelComsumption','EngineSpeed', 'EngineTorque'});
writetable(T, 'BaselineICVProfiles.csv');
