...
class World(object):
    ...
    def restart(self):
        ...
        blueprint = self.find_blueprint(self.vehicle_type)
    ...
    def find_blueprint(self, vehicle_type):
        blueprint = self.world.get_blueprint_library().find(vehicle_type)
        return blueprint
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            # role_name = world.player.attributes.get("role_name", "undefined")
            # print(f"Actor ID: {world.player.id}, role_name: {role_name}")
...
def main():
    ...
    args.host = carla_server_ip
    args.port = carla_server_port
    args.rolename = 'ego'
    args.vehicle_type = 'vehicle.dodge.charger_police'
